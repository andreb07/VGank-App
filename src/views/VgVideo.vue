        ...
        <div class="col right">  
          ...
          <div class="shareicons" ref="shareicons">
              ...
              <div class="center">
                ...
                <a :href="AppShareLinks.whatsapp + videodata.permalink" target="_blank">
                ...
                <a :href="AppShareLinks.facebook + videodata.permalink" target="_blank">
                  <svg viewBox="0 0 1000 1000">
                ...
                <a :href="AppShareLinks.twitter + videodata.permalink" target="_blank">
                  <svg viewBox="0 0 1000 1000" >
                ...
                <a :href="AppShareLinks.email + videodata.permalink" target="_blank">
