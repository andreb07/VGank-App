<template>
   ...
   <div class="document-previewer-wrapper-a717db">
      <div data-custom-class="body">
         <div><strong><span style="font-size: 26px;"><span data-custom-class="title">VGANK PRIVACY POLICY</span></span></strong></div>
         
         <div>
            <span style="color: rgb(127, 127, 127);">
               <strong>
                  <span style="font-size: 13px; opacity: .3;">
                     <span data-custom-class="subtitle">
                        Last updated 
                        <bdt class="question">October 23, 2022</bdt>
                     </span>
                  </span>
               </strong>
            </span>
               ...
               <span style="font-size: 15px; color: rgb(89, 89, 89);">
                  <span style="font-size: 15px; color: rgb(89, 89, 89);">
                     <span data-custom-class="body_text">
                        ...
                        <bdt class="block-component"></bdt>
                        at 
                        <bdt class="question"><a href="https://vgank.net" target="_blank" data-custom-class="link">https://vgank.net</a></bdt>
                        <span style="font-size: 15px;">
                           <span style="color: rgb(89, 89, 89);">
                              <span data-custom-class="body_text">
                                 <span style="font-size: 15px;">
         ...
         <div>
               ...
               <span style="font-size: 15px;">
                  <span style="color: rgb(127, 127, 127);">
                     <span data-custom-class="body_text">
                        ...
                        <bdt class="question">hello@vgank.net</bdt>
                        .
                     </span>
                  </span>
               </span>
            ...
            <div style="line-height: 1.5;">
               ...
               <a data-custom-class="link" href="https://app.termly.io/notify/462481e0-d51d-4ef4-ab0c-2cbcc62fa659" rel="noopener noreferrer" target="_blank"><span style="font-size: 15px;"><span data-custom-class="body_text">here</span></span></a>
               <span style="font-size: 15px;">
                  <span data-custom-class="body_text">
                     <bdt class="block-component"></bdt>
                                                                                                   ...
                                                                                                   <div style="line-height: 1.5;">
                                                                                                      <span style="font-size: 15px; color: rgb(89, 89, 89);">
                                                                                                         <span style="font-size: 15px; color: rgb(89, 89, 89);">
                                                                                                            ...
                                                                                                            <span style="color: rgb(48, 48, 241);"><span data-custom-class="body_text"><span style="font-size: 15px;"><a data-custom-class="link" href="https://app.termly.io/notify/462481e0-d51d-4ef4-ab0c-2cbcc62fa659" rel="noopener noreferrer" target="_blank">here</a></span></span></span>
                                                                                                            <bdt class="block-component"><span data-custom-class="body_text"></span></bdt>
                                                                                                         </span>
                                                                                                      </span>
